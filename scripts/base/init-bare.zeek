...
export {
	...
	## NTP message as defined in :rfc:`5905`.  Does include fields for mode 6
	## (control, :rfc:`1119`) and mode 7 (private, reserved in :rfc:`5905`),
	## used in some implementations for commands such as "monlist".
